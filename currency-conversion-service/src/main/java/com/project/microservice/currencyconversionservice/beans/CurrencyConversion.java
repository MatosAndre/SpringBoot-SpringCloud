package com.project.microservice.currencyconversionservice.beans;
...
public class CurrencyConversion {
    ...
    public CurrencyConversion(Long id, String from, String to, BigDecimal quantity, BigDecimal conversionMultiple, BigDecimal totalCalculatedAmmount, String environment) {
        this.id = id;
        this.from = from;
        this.to = to;
